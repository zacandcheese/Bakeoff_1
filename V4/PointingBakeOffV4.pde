...
void drawButton(int i)
{
  ...
  ellipse(bounds.x + bounds.width / 2, bounds.y + bounds.height / 2, 0.5*bounds.width, 0.5*bounds.height); //draw button 
...
void drawEnlargedButton(int i)
{
  ...
  ellipse(bounds.x + bounds.width / 2, bounds.y + bounds.height / 2, 0.75*bounds.width, 0.75*bounds.height); //draw button 
